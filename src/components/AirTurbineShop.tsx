...
>
  Zunera Air Ventilators & Turbines
      ...
      <footer className="mt-24 bg-slate-900 text-white">
        ...
        <div className="border-t border-slate-800 text-slate-500 text-sm py-4 text-center">© {new Date().getFullYear()} Zunera Co. All rights reserved. developed by Abdul sattar shaikh</div>
      </footer>
    </div>
  );
}